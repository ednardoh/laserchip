...
begin
    LeINI();
     ...
     try
        ...
        if OSAuthent then
          Conexao.Params.Add('OSAuthent=Yes')
        else
          Conexao.Params.Add('OSAuthent=No');
        Conexao.Open();
...
begin
  ...
  try
    ...
    ArqIni.WriteBool(Secao,'OSAuthent', OSAuthent);
  finally
     ArqIni.Free;
  end;
end;
...
begin
  ...
  try
    ...
    OSAuthent   := ArqIni.ReadBool(Secao, 'OSAuthent', false);
  finally
     ArqIni.Free;
  end;
end;
